...
![Format](https://img.shields.io/badge/Format-Standalone%20%7C%20AU%20%7C%20VST3-blueviolet?style=flat-square)
...
2. Extract & Copy `Dubchords1.0.0.component` to `/Library/Audio/Plug-Ins/Components`.
...
2. Extract & Copy `Dubchords1.0.0.vst3` to `/Library/Audio/Plug-Ins/VST3`.
3. Rescan plugins in Ableton Live 12.
4. Create a MIDI track.
5. Load `Dub Chords` onto the MIDI track.
